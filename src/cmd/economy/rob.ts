        ...
        try {
            ...
            if (!cooldownResult.can) {
                const embed = new ReplyEmbed()
                    ...
                    .setTitle(cfg.legacy.customization.economyTexts.robbing.waitHeader)
                    .setDescription(cfg.legacy.customization.economyTexts.robbing.waitText.replaceAll('<seconds>', cooldownResult.discordTime));
