...
export class MissingRequiredArgError extends ArgParseError {
    ...
    constructor(argName: string, argType: CommandArgType) {
        super();
...
export class ArgViolatesRules extends ArgParseError {
    ...
    constructor(argName: string, argType: CommandArgType, violatedRule: CommandViolatedRule) {
        super();
        this.argName = argName;
        this.argType = argType;
        this.violatedRules = violatedRule;
    }
}
