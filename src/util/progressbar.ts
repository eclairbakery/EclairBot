...
export function mkDualProgressBar(red: number, green: number, totalLength: number = 8) {
    assert(red <= totalLength/2);
    assert(green <= totalLength/2);

    return '<:dark_red_block:1416021203331715082>'.repeat(totalLength / 2 - red)
        + '<:light_red_block:1416021243379056700>'.repeat(red)
        + '<:light_green_block:1416021218485600357>'.repeat(green)
        + '<:dark_green_block:1416021182964043856>'.repeat(totalLength / 2 - green);
}
